...
const PhoneFrame: React.FC<PhoneFrameProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4 overflow-hidden" style={{ height: '100vh', position: 'fixed', width: '100vw', top: 0, left: 0 }}>
